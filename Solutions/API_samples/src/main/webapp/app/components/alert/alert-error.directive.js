(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('apiSamplesApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-apiSamplesApp-error');
                var entityKey = httpResponse.headers('X-apiSamplesApp-params');
                if (errorHeader) {

...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "API_samples@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "API_samples API";

        private String description = "API_samples API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "API_samples";
